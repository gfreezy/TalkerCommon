...
@MainActor
@Observable public class CmRouter
{
...
public struct CmRouterView<Content: View, Dest: View>: View {
    ...
    public init(delegate: CmRouterDelegateProtocol? = nil, @ViewBuilder content: () -> Content, @ViewBuilder destView: @escaping (CmRouterPath) -> Dest) {
        self.delegate = delegate
        self.view = content()
        self.destinationView = destView
    }
    
    public init(delegate: CmRouterDelegateProtocol? = nil, @ViewBuilder content: () -> Content, @ViewBuilder destView: @escaping (String, [String: String]) -> Dest) {
        self.delegate = delegate
        self.view = content()
